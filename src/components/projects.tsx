...
const DUMMY_PROJECTS: Project[] = [
  {
    ...
    description: "A curated list of awesome GitHub Profile READMEs with creative ideas and implementations",
    language: "JavaScript",
  ...
  },
  {
    id: 2,
    name: "word-counter",
    description: "A blazingly fast CLI tool to count words, characters, and lines in text files",
    language: "Rust",
  ...
  },
  {
    ...
    description: "Generate custom Pokemon trading cards with your own stats and images",
    language: "TypeScript",
  ...
  },
  {
    id: 4,
    name: "git-stalk-cli",
    description: "Stalk GitHub users via command line with beautiful charts and stats",
    language: "Python",
  ...
  },
  {
    id: 5,
    name: "nibbles-dev",
    description: "Weekly tech newsletter covering latest in web development, AI, and developer tools",
    language: "MDX",
  ...
  },
  {
    ...
    description: "Automatically generate test cases for competitive programming problems",
    language: "Go",
